...
import { useMenuDispatch, useMenuSelector } from '../../hooks/redux/hooks';
import { changeTab, toggleMenuOpen } from '../../store/menu-store';
...
export function PortalMenu({ user }: PortalMenuProps) {
  ...
  const { tabRoutes, cti, isOpen } = useMenuSelector((state) => ({
